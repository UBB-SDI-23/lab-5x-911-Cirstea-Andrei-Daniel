...
//    }
//
//    public Distributor ValidateUserRole(Long elementID) throws Exception {
//        // Check to see if the request user is the same as the session one
//        Distributor element = findID(elementID);
//        if (element == null) {
//            throw new Exception("Distributor with id " + elementID + " doesn't exist");
//        }
//        user_service.ValidateUser(element, "ROLE_REGULAR");
//        return element;
//    }
//
//    public Distributor updateDistributor(Distributor distributor, Long distributorID) throws Exception {
//        Distributor old_distributor = ValidateUserRole(distributorID);
...
//        ValidateUserRole(distributorID);
...
@Service
public class DistributorService extends ServiceBase<DistributorDTO, Distributor> {
